            ...
            <v-card>
              ...
              <v-list>
                <v-list-tile>
                  ...
                  <v-list-tile-content>
                    <v-list-tile-sub-title>Web Console</v-list-tile-sub-title>
                    <router-link slot="activator" class="cyan--text text--darken-2" :to="{ name: 'ShootWebConsole', params: { name: shootName, namespace } }">
                      <span>All available Web Consoles</span>
                    </router-link>
                  </v-list-tile-content>
                </v-list-tile>
              </v-list>
